...
assert 12 "int main() { return -4 + +16; }"
assert 6 "int main() { return -4 + 10; }"
...
assert 8 "int main() { int a=4; int a=8; return a; }"
...
assert 7 "int main() { return add2(4, 3); } int add2(int x, int y) { return x + y; }"
...
# global variables
assert 0 "int x; int main() { return x; }" # callocされているから初期値は0
